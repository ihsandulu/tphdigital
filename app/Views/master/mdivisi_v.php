                    ...
                    <?php if (isset($_POST['new']) || isset($_POST['edit'])) { ?>
                        <div class="">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">     
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="divisi_name">Nama Divisi:</label>
                                    <div class="col-sm-10">
                                        <input required type="text" autofocus class="form-control" id="divisi_name" name="divisi_name" placeholder="" value="<?= $divisi_name; ?>">
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a class="btn btn-warning col-md-offset-1 col-md-5" href="<?= base_url("mdivisi"); ?>">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                            ...
                                            <?php if (!isset($_GET["report"])) { ?>
                                                <td style="padding-left:0px; padding-right:0px;">
                                                    ...
                                                    <form method="post" class="btn-action" style="">
                                                        ...
                                                        <input type="hidden" name="divisi_id" value="<?= $usr->divisi_id; ?>" />
                                                    </form>
                                                    <?php }?>
